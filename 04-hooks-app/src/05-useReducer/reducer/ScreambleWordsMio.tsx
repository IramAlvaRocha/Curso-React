...
export const ScrambleWords = () => {
    ...
    const handleGuessSubmit = (e: React.FormEvent) => {
        ...
        if (guess === currentWord) {
            //Aumentamos en 1 los puntos obtenidos por el usuario
            setPoints(prevValue => prevValue + 1)

            //Eliminamos la palabra de actual que el jugador adivinó
            ...
            //Establecemos el nuevo conjunto de palabras sin la palabra actual que adivinó el jugador
            setWords(newWords)

            //Establecemos la próxima palabra que a adivinar
            ...
            const currentErrors = errorCounter + 1

            setErrorCounter(currentErrors);
            setGuess('');

            if (currentErrors === maxAllowErrors) {
                setIsGameOver(true)
            }
        }
    ...
    const handleSkip = () => {
        ...
        //Reordenamos el array de palabras
        const [firstWord, ...rest] = words;

        const newWords = [...rest, firstWord];
        setWords(newWords)
    ...
    const handlePlayAgain = () => {
        ...
        // 2. Ahora usa esa MISMA lista mezclada para todas las actualizaciones
